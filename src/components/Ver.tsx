        ...
        <div className="-mx-4 flex flex-wrap items-center justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mt-10 lg:mt-0">
              ...
              <button
                type="button"
                className="animate-bounce bg-transparent hover:bg-musgo-500 text-pele-400 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded hover:ease-out duration-300"
              >
                Contato
              </button>
            </div>
